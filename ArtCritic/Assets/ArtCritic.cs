...
// from model file ArtCritic.onnx
...
namespace MNIST_Demo
{
    ...
    public sealed class ArtCriticInput
    {
        public ImageFeatureValue data; // BitmapPixelFormat: Bgra8, BitmapAlphaMode: Premultiplied, width: 224, height: 224
    }
    
    public sealed class ArtCriticOutput
    {
        public TensorString classLabel; // shape(-1,1)
        public IList<IDictionary<string,float>> loss;
    }
    
    public sealed class ArtCriticModel
    {
        private LearningModel model;
        private LearningModelSession session;
        private LearningModelBinding binding;
        public static async Task<ArtCriticModel> CreateFromStreamAsync(IRandomAccessStreamReference stream)
        {
            ArtCriticModel learningModel = new ArtCriticModel();
